...
export function ProfessionalForm({ titles, services }: ProfessionalFormProps) {
  ...
  return (
    <div className="flex flex-col gap-6 max-w-4xl">
      ...
      {/* Banner de error general (solo para errores de negocio / servidor, no de validación inline) */}
      ...
      {/* Formulario principal: se oculta al registrar con éxito para evitar reenvíos */}
      {!created && (
