...
export type SeedAppointment = {
  ...
  patient: string;
  service: string;
  /// Semana relativa a la de la corrida del seed: -1 la anterior, 0 la actual
  /// y 1 la siguiente. Los turnos cerrados van en la anterior, que siempre
  /// pasó: completar exige que el turno haya comenzado y vencerlo, que haya
  /// terminado (HU-11).
  week: -1 | 0 | 1;
  weekday: Weekday;
  ...
  requestedBy?: string;
  /// Email del usuario que dio el turno y, si corresponde, cambió su estado.
  createdBy: string;
};
...
export const APPOINTMENTS: SeedAppointment[] = [
  ...
  },
  {
    ...
    startTime: "09:30",
    status: EXPIRED,
    reason: "La paciente no se presentó.",
    createdBy: MESA,
  },
  {
    professional: "4521",
    patient: "33456789",
    service: "Infiltración articular",
    week: -1,
    weekday: MONDAY,
    startTime: "10:00",
    status: SCHEDULED,
  ...
  },
  {
    professional: "3312",
    patient: "13456789",
    service: "Control post-quirúrgico",
    week: -1,
    weekday: MONDAY,
    startTime: "09:00",
    status: COMPLETED,
  ...
  },
  {
    professional: "8120",
    patient: "38912345",
    service: "Evaluación kinesiológica inicial",
    week: -1,
    weekday: MONDAY,
    startTime: "08:00",
    status: COMPLETED,
  ...
  },
  {
    professional: "5610",
    patient: "55123456",
    service: "Consulta de traumatología infantil",
    week: -1,
    weekday: MONDAY,
    startTime: "14:00",
    status: COMPLETED,
  ...
  },
  {
    ...
    startTime: "08:30",
    status: CANCELLED,
    reason: "Avisó por teléfono que no puede asistir.",
    requestedBy: "La paciente",
    createdBy: MESA2,
  },
  {
    professional: "2873",
  ...
  },
  {
    professional: "8120",
    patient: "38912345",
    service: "Sesión de kinesiología motora",
    week: -1,
    weekday: WEDNESDAY,
    startTime: "08:00",
    status: COMPLETED,
  ...
  },
  {
    professional: "5610",
    patient: "53987654",
    service: "Colocación y retiro de yeso",
    week: -1,
    weekday: WEDNESDAY,
    startTime: "14:30",
    status: SCHEDULED,
  ...
  },
  {
    professional: "3312",
    patient: "10234567",
    service: "Curación y retiro de puntos",
    week: -1,
    weekday: THURSDAY,
    startTime: "10:00",
    status: SCHEDULED,
  ...
  },
  {
    ...
    startTime: "10:00",
    status: CANCELLED,
    reason: "Pidió pasarlo a la semana próxima.",
    requestedBy: "La paciente",
    createdBy: MESA,
  },
  {
