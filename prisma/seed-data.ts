...
export const PROFESSIONALS: SeedProfessional[] = [
  ...
  },
  {
    ...
    licenseNumber: "6891",
    phone: "387 155-3120",
    email: "geronimo.rivero@example.com",
    notes: null,
    titles: [TRAUMATOLOGIST],
    services: [
      "Consulta traumatológica general",
  ...
  // Recién incorporada y sin franjas: no aparece para dar turnos (HU-05 y
  // HU-09). Con ella el listado pasa de una página (HU-04).
  {
    lastName: "Aguirre",
    firstName: "Valeria",
    documentType: DocumentType.DNI,
    documentNumber: "38456120",
    licenseNumber: "9377",
    phone: "387 156-8845",
    email: "valeria.aguirre@example.com",
    notes: "Se incorpora en octubre; falta cargar la agenda.",
    titles: [KINESIOLOGIST],
    services: ["Sesión de kinesiología motora"],
    userEmail: null,
    deactivation: null,
  },
...
export const AVAILABILITY: Record<string, SeedWindow[]> = {
  ...
  "6891": weekly([WEDNESDAY, FRIDAY], "08:00", "12:00", "Consultorio 2"),
};

export type SeedException = {
  /// Matrícula del profesional.
  professional: string;
  /// Semana relativa a la de la corrida, como en los turnos. Siempre futura:
  /// la UI no deja cargar excepciones en fechas pasadas.
  week: 1 | 2 | 3;
  weekday: Weekday;
  /// `HH:MM`. Sin horario, el día entero.
  startTime?: string;
  endTime?: string;
  reason: string;
};

/// Excepciones al patrón semanal (HU-05): ausencias de día completo y de una
/// parte de la franja. Ningún turno del seed cae adentro.
export const AVAILABILITY_EXCEPTIONS: SeedException[] = [
  {
    professional: "4521",
    week: 1,
    weekday: WEDNESDAY,
    startTime: "09:00",
    endTime: "11:00",
    reason: "Cirugía programada en el sanatorio.",
  },
  {
    professional: "5610",
    week: 1,
  ...
  },
  {
    ...
    week: 2,
    weekday: THURSDAY,
    reason: "Congreso Argentino de Kinesiología.",
  },
  {
    professional: "7985",
    week: 2,
  ...
  },
  {
    ...
    week: 2,
    weekday: SATURDAY,
    reason: "Viaja con el club al torneo regional.",
  },
];

export type SeedProfessionalEvent = {
  /// Matrícula del profesional.
  professional: string;
  type: "UPDATED" | "DEACTIVATED" | "REACTIVATED";
  /// AAAA-MM-DD.
  date: string;
  reason: string;
  changes: Record<string, string | Record<string, string>> | null;
};

/// Historial de cambios (HU-03), además de la baja de Lamas, que sale de su
/// `deactivation`. Saravia estuvo de baja y volvió: queda activo.
export const PROFESSIONAL_HISTORY: SeedProfessionalEvent[] = [
  {
    professional: "3312",
    type: "DEACTIVATED",
    date: "2026-07-15",
    reason: "Licencia por cirugía de cadera.",
    changes: { deactivatedAt: "2026-07-15" },
  },
  {
    professional: "3312",
    type: "REACTIVATED",
    date: "2026-08-24",
    reason: "Terminó la licencia y retoma la agenda.",
    changes: null,
  },
  {
    professional: "2873",
    type: "UPDATED",
    date: "2026-09-10",
    reason: "Cambió su teléfono de contacto.",
    changes: {
      before: { phone: "387 422-1100" },
      after: { phone: "387 422-8765" },
    },
  },
];
...
export type SeedPatient = {
  ...
  createdBy: string;
  /// Email del usuario que lo modificó después del alta (HU-08), si alguien.
  updatedBy?: string;
};
...
export type SeedAppointment = {
  ...
  /// y de 1 a 3 las siguientes (el horizonte de HU-09 es de dos meses). Los
  /// turnos cerrados van en la anterior, que siempre pasó: completar exige que
  /// el turno haya comenzado y vencerlo, que haya terminado (HU-11).
  week: -1 | 0 | 1 | 2 | 3;
  weekday: Weekday;
...
export const APPOINTMENTS: SeedAppointment[] = [
  ...
  },
  {
    ...
    startTime: "16:30",
    status: CANCELLED,
    reason: "El profesional suspendió la tarde por una urgencia.",
  ...
  },
  {
    ...
    startTime: "11:00",
    status: CANCELLED,
    reason: "Viaja por un trámite familiar.",
    requestedBy: "La paciente",
    createdBy: MESA2,
  },
  {
  ...
  },
  {
    ...
    status: SCHEDULED,
    createdBy: MESA2,
    notes: "Reprogramado: canceló el turno de la semana pasada.",
  },
  {
    professional: "2873",
    patient: "31245678",
  ...
  },
  {
    ...
    status: SCHEDULED,
    createdBy: MANAGER_EMAIL,
    notes: "Artroscopía de rodilla derecha hace tres semanas.",
  },
  {
    professional: "4521",
    patient: "43789012",
  ...
  },
  {
    ...
    status: SCHEDULED,
    createdBy: MESA,
    notes: "Volvió a pedir turno después de ausentarse la semana pasada.",
  },
  {
    professional: "4521",
    patient: "33456789",
    ...
    status: SCHEDULED,
    createdBy: MESA,
    notes: "Trae la orden médica y el ácido hialurónico.",
  },
  {
    professional: "5610",
    patient: "56234512",
  ...
  },
  {
    ...
    status: SCHEDULED,
    createdBy: MESA,
    notes: "Trae la orden de la infiltración.",
  },
  {
    professional: "7985",
    patient: "41234567",
  ...
  },
  {
    ...
    status: SCHEDULED,
    createdBy: MESA,
    notes: "Reprogramado: pidió pasarlo desde la semana anterior.",
  },
  {
    professional: "4521",
    patient: "29345612",
    ...
    status: SCHEDULED,
    createdBy: MESA2,
    notes: "Segunda infiltración de la serie.",
  },
  {
    professional: "2873",
    patient: "24567890",
